...
function exp_PGTUAnnessoD_5rule0_eval_expression(context) {
    // Classifica = 'A'
...
function exp_PGTUAnnessoD_5rule1_eval_expression(context) {
    // Classifica = 'S'
...
function exp_PGTUAnnessoD_5rule2_eval_expression(context) {
    // Classifica = 'IQ'
...
function exp_PGTUAnnessoD_5rule3_eval_expression(context) {
    // Classifica = 'Q'
...
function exp_PGTUAnnessoD_5rule4_eval_expression(context) {
    // Classifica = 'IZ'
