...
function exp_PGTUAnnessoD_4rule0_eval_expression(context) {
    // Classifica = 'A'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Classifica')  == 'A');
    } else {
        return (feature.get('Classifica')  == 'A');
    }
}
...
function exp_PGTUAnnessoD_4rule1_eval_expression(context) {
    // Classifica = 'S'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Classifica')  == 'S');
    } else {
        return (feature.get('Classifica')  == 'S');
    }
}
...
function exp_PGTUAnnessoD_4rule2_eval_expression(context) {
    // Classifica = 'IQ'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Classifica')  == 'IQ');
    } else {
        return (feature.get('Classifica')  == 'IQ');
    }
}
...
function exp_PGTUAnnessoD_4rule3_eval_expression(context) {
    // Classifica = 'Q'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Classifica')  == 'Q');
    } else {
        return (feature.get('Classifica')  == 'Q');
    }
}
...
function exp_PGTUAnnessoD_4rule4_eval_expression(context) {
    // Classifica = 'IZ'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Classifica')  == 'IZ');
    } else {
        return (feature.get('Classifica')  == 'IZ');
    }
}